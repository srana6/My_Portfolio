...
var HTMLgithub="<li class='flex-item'><span class='orange-text'>Github:</span><span class='white-text gitlink'>%data%</span></li>";
var HTMLlinkedin="<li class='flex-item'><span class='orange-text'>LinkedIn:</span><span class='white-text linkedinlink'>%data%</span></li>";
...
var HTMLworkTitle1="     -  %data%</a>";
var HTMLworkDates1 = "<div class='date-text'>%data%</div>";
var HTMLworkLocation1 = "<div class='location-text'>%data%</div>";
var HTMLworkDescription1 = "<p class='desc'><br>%data%</p>";

var HTMLworkEmployer2 ="<a href='https://www.horizonblue.com/' target='_blank'>%data%";
var HTMLworkTitle2="     -  %data%</a>";
var HTMLworkDates2 = "<div class='date-text'>%data%</div>";
...
var HTMLprojectTechnologies = "<div class='date-text'>%data%</div>";
...
var HTMLeducationDegree = " -- %data%</a>";
var HTMLeducationDate = "<div class='date-text'>%data%</div>";
